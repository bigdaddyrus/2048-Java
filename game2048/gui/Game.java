...
public class Game {
    ...
    public void moveTile(int value, int row, int col, int newRow, int newCol) {
        //System.out.println("tiles to be moved (" + row + ", " + col + ") value is: " + _tiles[row][col]);
        ...
        if (_tiles2[row][col] != null) {
            ...
            throw badArg("wrong value (%d) for tile at (%d, %d)",
             ...
             System.out.println("moving destination at (" + newRow + ", " + newCol + ") value is: " + _tiles[newRow][newCol]);
        ...
        System.out.println("movetile tile at (" + 1 + ", " + 1 + ") value is: " + _tiles[1][1]);
        /*
    ...
    public void mergeTile(int value, int newValue, int row, int col,
        ...
        System.out.println("mergetile tile at (" + 1 + ", " + 1 + ") value is: " + _tiles[1][1]);
        //System.out.println("merging tile at (" + row + ", " + col + ") value is: " + _tiles[row][col]);
        /*System.out.println(row);
        System.out.println(col);
        System.out.println(newRow);
        System.out.println(newCol);
    ...
    public void displayMoves() {
        ...
        System.out.println("displaymoves tile at (" + 1 + ", " + 1 + ") value is: " + _tiles[1][1]);
        _moves = 0;
        _tiles = _nextTiles;
        _tiles2 = new Tile[_rows][_rows];
        _nextTiles = new Tile[_rows][_rows];
